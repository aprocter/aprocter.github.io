...
\section{Conference Publications} \begin{bibsection}
    ...
    \item Michela Becchi, Kittisak Sajjapongse, Ian Graves, Adam Procter, Vignesh Ravi, and Srimat Chakradhar.
            A Virtual Memory Based Runtime to Support Multitenancy in Clusters with Many-cores. \emph{Proceedings of the 21st International Symposium on High-Performance Parallel and Distributed Computing (HPDC'12)}, Delft, June 2012. {\bf (Best paper award!)}
...
\begin{bibsection}
    ...
    \item William L. Harrison, Gerard Allwein, Andy Gill, and Adam Procter.
        Asymchronous Exceptions as an Effect. \emph{Proceedings of the Ninth
